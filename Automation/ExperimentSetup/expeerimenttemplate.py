...
sourcedir2='../DatasetSplitter/testsource2/'
sourcedir3='../DatasetSplitter/testsource3/'
#numfiles = 9500
numfiles = 10
...
def createexperiment(podname):
    ...
    experiment.imagineaclnormal(openperc=100,mean=themean, disp=0,filelabel=filelab1)
